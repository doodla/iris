...
enforced, see [docs/contributing/architecture.md](docs/contributing/architecture.md); for adding a provider, see
...
`schema_version` bump (see [docs/reference/json-output.md](docs/reference/json-output.md)).
...
- **Live verification is separate, paid, and opt-in.** It is never run in CI and never run as
  part of `cargo test`. See [docs/contributing/live-testing.md](docs/contributing/live-testing.md) for what it verifies,
...
"clean up" code it doesn't need to touch. If you're adding a provider, [docs/contributing/adding-a-provider.md](docs/contributing/adding-a-provider.md)
