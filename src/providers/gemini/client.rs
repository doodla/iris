...
//! public error taxonomy (see docs/reference/errors.md).
...
/// shared by every adapter (see docs/reference/errors.md).
...
/// Map a non-success response to the public taxonomy (see docs/reference/errors.md).
